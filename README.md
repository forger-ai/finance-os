...
Aplicación personal para consolidar, revisar y clasificar movimientos financieros con ayuda de agentes. Finance OS usa un stack portable: **FastAPI + SQLite + Vite + React**, ideal para correr en local con Docker o Forger.
